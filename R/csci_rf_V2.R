...
# pickVars (20): "RdCrsWs"            "PctImp2011Ws"       "PctImp2011CatRp100" "RdDensWs"     # "PctImp2011Cat"      "PctAgWsRp100"       "PctUrbWsRp100"      "CanalDensWs"       
# "PctUrbWs"           "PctAgWs"            "PctImp2011WsRp100"  "PctUrbCatRp100"    
# "PctUrbCat"          "MineDensWs"         "RdDensWsRp100"      "FertWs"            
# "RdDensCat"          "CBNFWs"             "AgKffactWs"         "RdDensCatRp100"  
...
rf_dat2 <- mydf2_train %>%
  select(csci, RdCrsWs, PctImp2011Ws, PctImp2011CatRp100, RdDensWs, PctImp2011Cat, PctAgWsRp100, PctUrbWsRp100, CanalDensWs, PctUrbWs, PctAgWs, PctImp2011WsRp100, PctUrbCatRp100, PctUrbCat, MineDensWs, RdDensWsRp100, FertWs, RdDensCat, CBNFWs, AgKffactWs, RdDensCatRp100)
...
#### Results .csv ####
# Export results.
write_csv(ca_predictions2, "data_model_outputs/csci_rf_results_V2.csv")
...
write_csv(ca_sum, "data_model_outputs/csci_rf_results_summary_V2.csv")
...
write_csv(csci_lms,"data_model_outputs/csci_lms_V2.csv" )
...
write_csv(process_summary, "data_model_outputs/csci_process_summary_V2.csv")
...
dc$error.cv
# 34         24         17         12          8          6          4          3 
# 0.03122456 0.03164610 0.03180793 0.03292306 0.03478002 0.03513375 0.03721054 0.03774943 
# 2          1 
# 0.04530931 0.05613665 
